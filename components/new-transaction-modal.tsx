    ...
    try {
      ...
      const timeoutPromise = new Promise((_, reject) => {
        setTimeout(
          () =>
            reject(
              new Error("Tempo de espera excedido. Verifique sua conexão."),
            ),
          30000,
        );
      });
      ...
      // Mostrar notificação de sucesso com helper padronizado
      showTransactionSuccess(tipo);
            ...
            <View style={styles.section}>
              ...
              <View style={styles.typeButtons}>
                <TouchableOpacity
                  ...
                  onPress={() => !loading && setTipo("receita")}
                  disabled={loading}
                  activeOpacity={loading ? 1 : 0.7}
                >
                  <IconSymbol
                ...
                <TouchableOpacity
                  ...
                  onPress={() => !loading && setTipo("despesa")}
                  disabled={loading}
                  activeOpacity={loading ? 1 : 0.7}
                >
                  <IconSymbol
              ...
              <View style={styles.section}>
                ...
                <View style={styles.accountButtons}>
                  <TouchableOpacity
                    ...
                    onPress={() => !loading && setContaBancariaId(null)}
                    disabled={loading}
                    activeOpacity={loading ? 1 : 0.7}
                  >
                    <ThemedText
                  ...
                  {contas.map((conta) => (
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        !loading && setContaBancariaId(conta.id || null)
                      }
                      disabled={loading}
                      activeOpacity={loading ? 1 : 0.7}
                    >
