...
export default function BankConnectionsScreen() {
  ...
  const [selectedConnection, setSelectedConnection] =
    useState<OpenFinanceConnection | null>(null);
  ...
  }, [userId, selectedCompany, showError]);
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              showInfo(
                `Renovando consentimento de ${connection.bank_name}...`,
                { iconType: "link", duration: 2000 },
              );
              ...
              const bankName =
                getBankByCode(connection.bank_code)?.name ||
              ...
              const bankName =
                ...
                connection.bank_name;
              showError(
                error.message || "Não foi possível renovar o consentimento",
                {
                  iconType: "link",
                  title: `Erro - ${bankName}`,
                },
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              showInfo(`Revogando conexão com ${connection.bank_name}...`, {
                iconType: "link",
                duration: 2000,
              });
              await revokeConsent(
              ...
              const bankName =
                ...
                connection.bank_name;
              showSuccess(
                `Conexão revogada · Você pode reconectar a qualquer momento`,
                {
                  iconType: "link",
              ...
              const bankName =
                ...
                connection.bank_name;
              showError(
                error.message || "Não foi possível revogar o consentimento",
                {
                  iconType: "link",
                  title: `Erro - ${bankName}`,
                },
  ...
  const handleImportTransactions = async (
    ...
    if (!connection.pluggy_item_id) {
      showError("Esta conexão não possui um item Pluggy vinculado.", {
        iconType: "link",
      });
      return;
    }
    ...
    const bankName =
      getBankByCode(connection.bank_code)?.name || connection.bank_name;
    showInfo(`Importando transações de ${bankName}...`, {
      iconType: "link",
      duration: 2000,
    });
    ...
    try {
      ...
      if (result.duplicates > 0) {
        showInfo(
          `${result.duplicates} transações já existem no sistema e foram ignoradas`,
          {
            iconType: "link",
            title: bankName,
            duration: 4500,
  ...
  const handleImportBalance = async (connection: OpenFinanceConnection) => {
    ...
    const bankName =
      getBankByCode(connection.bank_code)?.name || connection.bank_name;
    showInfo(`Importando saldo de ${bankName}...`, {
      iconType: "link",
      duration: 2000,
    });
    ...
    try {
      ...
      if (accounts.length === 0) {
        showInfo("Nenhuma conta encontrada para esta conexão.", {
          iconType: "link",
        });
        setImporting(null);
        return;
                  ...
                  <View style={styles.connectionHeader}>
                    ...
                    <View style={styles.connectionInfo}>
                      ...
                      <ThemedText style={styles.connectionAccount}>
                        {connection.account_type === "checking"
                          ? "Conta Corrente"
                          : connection.account_type === "savings"
                            ? "Poupança"
                            : "Investimento"}
                      </ThemedText>
                  ...
                  {expired && connection.status === "active" && (
                    <View style={styles.warningBanner}>
                      ...
                      <Text style={styles.warningText}>
                        Token expirado. Renove o consentimento para continuar
                        usando.
                      </Text>
                    </View>
                  )}
                      ...
                      <>
                        ...
                        >
                          <IconSymbol
                            ...
                            size={16}
                            color={
                              isImporting ? "rgba(0, 176, 155, 0.5)" : "#00b09b"
                            }
                          />
                          <Text
                            style={[
                              styles.actionButtonText,
                              isImporting && styles.actionButtonTextDisabled,
                            ]}
                          >
                            {isImporting
                              ? "Importando..."
                  ...
                  <View style={styles.logsRevokeRow}>
                    ...
                    >
                      <IconSymbol
                        ...
                        color="#EF4444"
                      />
                      <Text style={styles.actionButtonTextDanger}>Revogar</Text>
                    </TouchableOpacity>
                  </View>
                </GlassContainer>
              );
